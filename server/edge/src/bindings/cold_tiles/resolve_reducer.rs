...
tiles: Vec::<u8>,
        ...
        self.resolve_then(server_id, entity_key, tic, zone_id, tiles,  |_, _| {})
    }
...
tiles: Vec::<u8>,
        ...
        self.imp.invoke_reducer_with_callback(ResolveArgs { server_id, entity_key, tic, zone_id, tiles,  }, callback)
    }
}
