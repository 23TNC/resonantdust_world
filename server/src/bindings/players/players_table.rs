...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        ...
        pub trait playersQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `Player`.
            fn players(&self) -> __sdk::__query_builder::Table<Player>;
        }

        impl playersQueryTableAccess for __sdk::QueryTableAccessor {
            fn players(&self) -> __sdk::__query_builder::Table<Player> {
                __sdk::__query_builder::Table::new("players")
            }
        }
