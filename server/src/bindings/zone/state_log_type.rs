...
pub struct StateLogCols {
    ...
    pub cells: __sdk::__query_builder::Col<StateLog, Vec::<u64>>,
    pub biome: __sdk::__query_builder::Col<StateLog, u16>,
    pub version: __sdk::__query_builder::Col<StateLog, u32>,
