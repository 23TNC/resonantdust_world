...
version: u32,
        ...
        self.resolve_then(server_id, entity_key, tic, zone_id, cells, biome, version,  |_, _| {})
    }
...
version: u32,
        ...
        self.imp.invoke_reducer_with_callback(ResolveArgs { server_id, entity_key, tic, zone_id, cells, biome, version,  }, callback)
    }
}
