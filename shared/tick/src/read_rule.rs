...
//! is why the rule keys off absence, not a stale resolved row. Live design:
//! `docs/components/server/spacetime/modules/shard/intent/lifecycle.md` §"Defer until sources are
//! settled"; `docs/archive/simulation.md` is where it was first drafted.
