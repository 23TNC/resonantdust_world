...
import init, { WorldClient, Content, ticHz, defaultTicsPerTile, tileToPosition } from "@shared/resonantdust_shared.js";
...
export { WorldClient, Content, ticHz, defaultTicsPerTile, tileToPosition };
